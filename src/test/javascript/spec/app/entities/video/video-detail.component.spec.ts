...
import { RocolaYoutubeTestModule } from '../../../test.module';
    ...
    describe('Video Management Detail Component', () => {
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [RocolaYoutubeTestModule],
        ...
        describe('OnInit', () => {
            ...
            spyOn(service, 'find').and.returnValue(Observable.of(new Video('aaa')));
            ...
            expect(comp.video).toEqual(jasmine.objectContaining({id: 'aaa'}));
            });
        });
    });
